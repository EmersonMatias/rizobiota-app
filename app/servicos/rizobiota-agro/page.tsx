    ...
    <main className=" pb-20">
      ...
      <div className="w-full lg:max-w-[1000px] px-5 lg:mx-auto">
        <h2 className="font-gabarito text-center font-bold text-2xl tracking-widest  md:text-3xl lg:text-4xl mt-10">
          Rizobiota Agro: Desvende o Potencial do Seu Solo e{' '}
          <span className="text-secondary">Maximize Sua Produtividade!</span>
        </h2>

        <p className="mt-5 lg:text-xl lg:mt-10">
          Você busca otimizar a saúde do seu solo e impulsionar a produtividade da sua lavoura?
          Conheça o Rizobiota Agro, a análise avançada da microbiota do solo que te dá o poder de
          tomar decisões agronômicas verdadeiramente estratégicas!
        </p>
